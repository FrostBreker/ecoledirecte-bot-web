...
function shouldParse(diagnosis) {
  var isOk = !startsWith(diagnosis, ISEMAIL_ERR) || // is_email considers address with a domain beginning
  ...
  diagnosis === ISEMAIL_ERR_DOMAINHYPHENSTART || diagnosis === ISEMAIL_ERR_DOMAINHYPHENEND;
  return isOk;
